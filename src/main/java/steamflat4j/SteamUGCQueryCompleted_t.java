...
public class SteamUGCQueryCompleted_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SteamFlat.C_LONG_LONG.withName("m_handle"),
        SteamFlat.C_INT.withName("m_eResult"),
        SteamFlat.C_INT.withName("m_unNumResultsReturned"),
        SteamFlat.C_INT.withName("m_unTotalMatchingResults"),
        SteamFlat.C_BOOL.withName("m_bCachedData"),
        MemoryLayout.sequenceLayout(256, SteamFlat.C_CHAR).withName("m_rgchNextCursor"),
