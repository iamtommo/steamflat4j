...
public class RemoteStorageGetPublishedItemVoteDetailsResult_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat.C_LONG_LONG.withName("m_unPublishedFileId"),
        SteamFlat.C_INT.withName("m_nVotesFor"),
        SteamFlat.C_INT.withName("m_nVotesAgainst"),
        SteamFlat.C_INT.withName("m_nReports"),
        SteamFlat.C_FLOAT.withName("m_fScore")
