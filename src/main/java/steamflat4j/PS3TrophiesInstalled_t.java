 ...
 * }
 */
public class PS3TrophiesInstalled_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SteamFlat.C_LONG_LONG.withName("m_nGameID"),
        SteamFlat.C_INT.withName("m_eResult"),
        MemoryLayout.paddingLayout(4),
        SteamFlat.C_LONG_LONG.withName("m_ulRequiredDiskSpace")
    ).withName("PS3TrophiesInstalled_t");
    ...
    private static final OfLong m_ulRequiredDiskSpace$LAYOUT = (OfLong)$LAYOUT.select(groupElement("m_ulRequiredDiskSpace"));
     ...
     * }
     */
    public static final OfLong m_ulRequiredDiskSpace$layout() {
        return m_ulRequiredDiskSpace$LAYOUT;
    }

    private static final long m_ulRequiredDiskSpace$OFFSET = 16;
     ...
     * }
     */
    public static final long m_ulRequiredDiskSpace$offset() {
        return m_ulRequiredDiskSpace$OFFSET;
    }
     ...
     * }
     */
    public static long m_ulRequiredDiskSpace(MemorySegment struct) {
        return struct.get(m_ulRequiredDiskSpace$LAYOUT, m_ulRequiredDiskSpace$OFFSET);
    }
     ...
     * }
     */
    public static void m_ulRequiredDiskSpace(MemorySegment struct, long fieldValue) {
        struct.set(m_ulRequiredDiskSpace$LAYOUT, m_ulRequiredDiskSpace$OFFSET, fieldValue);
    }
