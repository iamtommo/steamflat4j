...
public class UserAchievementStored_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat.C_BOOL.withName("m_bGroupAchievement"),
        MemoryLayout.sequenceLayout(128, SteamFlat.C_CHAR).withName("m_rgchAchievementName"),
        MemoryLayout.paddingLayout(3),
        SteamFlat.C_INT.withName("m_nCurProgress"),
        SteamFlat.C_INT.withName("m_nMaxProgress"),
