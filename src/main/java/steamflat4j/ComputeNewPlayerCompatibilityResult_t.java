...
public class ComputeNewPlayerCompatibilityResult_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat.C_INT.withName("m_cPlayersThatDontLikeCandidate"),
        SteamFlat.C_INT.withName("m_cPlayersThatCandidateDoesntLike"),
        SteamFlat.C_INT.withName("m_cClanPlayersThatDontLikeCandidate"),
        SteamFlat.C_LONG_LONG.withName("m_SteamIDCandidate")
