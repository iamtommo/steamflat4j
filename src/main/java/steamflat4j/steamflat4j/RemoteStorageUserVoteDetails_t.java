...
public class RemoteStorageUserVoteDetails_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_INT.withName("m_eVote"),
        MemoryLayout.paddingLayout(4)
    ).withName("RemoteStorageUserVoteDetails_t");
    ...
    private static final OfInt m_eVote$LAYOUT = (OfInt)$LAYOUT.select(groupElement("m_eVote"));
     ...
     * }
     */
    public static final OfInt m_eVote$layout() {
        return m_eVote$LAYOUT;
    }

    private static final long m_eVote$OFFSET = 16;
     ...
     * }
     */
    public static final long m_eVote$offset() {
        return m_eVote$OFFSET;
    }
     ...
     * }
     */
    public static int m_eVote(MemorySegment struct) {
        return struct.get(m_eVote$LAYOUT, m_eVote$OFFSET);
    }
     ...
     * }
     */
    public static void m_eVote(MemorySegment struct, int fieldValue) {
        struct.set(m_eVote$LAYOUT, m_eVote$OFFSET, fieldValue);
    }
