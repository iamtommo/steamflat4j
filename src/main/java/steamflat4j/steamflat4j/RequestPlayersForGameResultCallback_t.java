...
public class RequestPlayersForGameResultCallback_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_LONG_LONG.withName("m_SteamIDPlayerFound"),
        SteamFlat4j.C_LONG_LONG.withName("m_SteamIDLobby"),
        SteamFlat4j.C_INT.withName("m_ePlayerAcceptState"),
        SteamFlat4j.C_INT.withName("m_nPlayerIndex"),
        SteamFlat4j.C_INT.withName("m_nTotalPlayersFound"),
        SteamFlat4j.C_INT.withName("m_nTotalPlayersAcceptedGame"),
        SteamFlat4j.C_INT.withName("m_nSuggestedTeamIndex"),
        MemoryLayout.paddingLayout(4),
