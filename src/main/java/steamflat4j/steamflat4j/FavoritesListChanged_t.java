...
public class FavoritesListChanged_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SteamFlat4j.C_INT.withName("m_nIP"),
        SteamFlat4j.C_INT.withName("m_nQueryPort"),
        SteamFlat4j.C_INT.withName("m_nConnPort"),
        SteamFlat4j.C_INT.withName("m_nAppID"),
        SteamFlat4j.C_INT.withName("m_nFlags"),
        SteamFlat4j.C_BOOL.withName("m_bAdd"),
        MemoryLayout.paddingLayout(3),
        SteamFlat4j.C_INT.withName("m_unAccountId")
