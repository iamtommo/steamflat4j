...
public class SearchForGameProgressCallback_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_LONG_LONG.withName("m_lobbyID"),
        SteamFlat4j.C_LONG_LONG.withName("m_steamIDEndedSearch"),
        SteamFlat4j.C_INT.withName("m_nSecondsRemainingEstimate"),
        SteamFlat4j.C_INT.withName("m_cPlayersSearching")
