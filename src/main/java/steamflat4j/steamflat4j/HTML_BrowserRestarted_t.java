...
public class HTML_BrowserRestarted_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_INT.withName("unOldBrowserHandle")
    ).withName("HTML_BrowserRestarted_t");
    ...
    private static final OfInt unOldBrowserHandle$LAYOUT = (OfInt)$LAYOUT.select(groupElement("unOldBrowserHandle"));
     ...
     * }
     */
    public static final OfInt unOldBrowserHandle$layout() {
        return unOldBrowserHandle$LAYOUT;
    }

    private static final long unOldBrowserHandle$OFFSET = 4;
     ...
     * }
     */
    public static final long unOldBrowserHandle$offset() {
        return unOldBrowserHandle$OFFSET;
    }
     ...
     * }
     */
    public static int unOldBrowserHandle(MemorySegment struct) {
        return struct.get(unOldBrowserHandle$LAYOUT, unOldBrowserHandle$OFFSET);
    }
     ...
     * }
     */
    public static void unOldBrowserHandle(MemorySegment struct, int fieldValue) {
        struct.set(unOldBrowserHandle$LAYOUT, unOldBrowserHandle$OFFSET, fieldValue);
    }
