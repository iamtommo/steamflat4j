...
public class EquippedProfileItems_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_BOOL.withName("m_bHasAnimatedAvatar"),
        SteamFlat4j.C_BOOL.withName("m_bHasAvatarFrame"),
        SteamFlat4j.C_BOOL.withName("m_bHasProfileModifier"),
        SteamFlat4j.C_BOOL.withName("m_bHasProfileBackground"),
        SteamFlat4j.C_BOOL.withName("m_bHasMiniProfileBackground"),
