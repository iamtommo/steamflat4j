...
public class SetUserItemVoteResult_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_BOOL.withName("m_bVoteUp"),
        MemoryLayout.paddingLayout(3)
    ).withName("SetUserItemVoteResult_t");
    ...
    private static final OfBoolean m_bVoteUp$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("m_bVoteUp"));
     ...
     * }
     */
    public static final OfBoolean m_bVoteUp$layout() {
        return m_bVoteUp$LAYOUT;
    }

    private static final long m_bVoteUp$OFFSET = 12;
     ...
     * }
     */
    public static final long m_bVoteUp$offset() {
        return m_bVoteUp$OFFSET;
    }
     ...
     * }
     */
    public static boolean m_bVoteUp(MemorySegment struct) {
        return struct.get(m_bVoteUp$LAYOUT, m_bVoteUp$OFFSET);
    }
     ...
     * }
     */
    public static void m_bVoteUp(MemorySegment struct, boolean fieldValue) {
        struct.set(m_bVoteUp$LAYOUT, m_bVoteUp$OFFSET, fieldValue);
    }
