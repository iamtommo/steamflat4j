...
public class WorkshopEULAStatus_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_INT.withName("m_unVersion"),
        SteamFlat4j.C_INT.withName("m_rtAction"),
        SteamFlat4j.C_BOOL.withName("m_bAccepted"),
        SteamFlat4j.C_BOOL.withName("m_bNeedsAction"),
