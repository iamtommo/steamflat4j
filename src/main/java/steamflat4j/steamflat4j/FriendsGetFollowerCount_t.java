...
public class FriendsGetFollowerCount_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_INT.withName("m_nCount"),
        MemoryLayout.paddingLayout(4)
    ).withName("FriendsGetFollowerCount_t");
    ...
    private static final OfInt m_nCount$LAYOUT = (OfInt)$LAYOUT.select(groupElement("m_nCount"));
     ...
     * }
     */
    public static final OfInt m_nCount$layout() {
        return m_nCount$LAYOUT;
    }

    private static final long m_nCount$OFFSET = 16;
     ...
     * }
     */
    public static final long m_nCount$offset() {
        return m_nCount$OFFSET;
    }
     ...
     * }
     */
    public static int m_nCount(MemorySegment struct) {
        return struct.get(m_nCount$LAYOUT, m_nCount$OFFSET);
    }
     ...
     * }
     */
    public static void m_nCount(MemorySegment struct, int fieldValue) {
        struct.set(m_nCount$LAYOUT, m_nCount$OFFSET, fieldValue);
    }
