...
public class gameserveritem_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_BOOL.withName("m_bHadSuccessfulResponse"),
        SteamFlat4j.C_BOOL.withName("m_bDoNotRefresh"),
        MemoryLayout.sequenceLayout(32, SteamFlat4j.C_CHAR).withName("m_szGameDir"),
        MemoryLayout.sequenceLayout(32, SteamFlat4j.C_CHAR).withName("m_szMap"),
        MemoryLayout.sequenceLayout(64, SteamFlat4j.C_CHAR).withName("m_szGameDescription"),
        MemoryLayout.paddingLayout(2),
        SteamFlat4j.C_INT.withName("m_nAppID"),
        SteamFlat4j.C_INT.withName("m_nPlayers"),
        SteamFlat4j.C_INT.withName("m_nMaxPlayers"),
        SteamFlat4j.C_INT.withName("m_nBotPlayers"),
        SteamFlat4j.C_BOOL.withName("m_bPassword"),
        SteamFlat4j.C_BOOL.withName("m_bSecure"),
        MemoryLayout.paddingLayout(2),
        SteamFlat4j.C_INT.withName("m_ulTimeLastPlayed"),
        SteamFlat4j.C_INT.withName("m_nServerVersion"),
        MemoryLayout.sequenceLayout(64, SteamFlat4j.C_CHAR).withName("m_szServerName"),
        MemoryLayout.sequenceLayout(128, SteamFlat4j.C_CHAR).withName("m_szGameTags"),
