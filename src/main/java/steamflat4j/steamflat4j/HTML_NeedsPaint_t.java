...
public class HTML_NeedsPaint_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat4j.C_POINTER.withName("pBGRA"),
        SteamFlat4j.C_INT.withName("unWide"),
        SteamFlat4j.C_INT.withName("unTall"),
        SteamFlat4j.C_INT.withName("unUpdateX"),
        SteamFlat4j.C_INT.withName("unUpdateY"),
        SteamFlat4j.C_INT.withName("unUpdateWide"),
        SteamFlat4j.C_INT.withName("unUpdateTall"),
        SteamFlat4j.C_INT.withName("unScrollX"),
        SteamFlat4j.C_INT.withName("unScrollY"),
        SteamFlat4j.C_FLOAT.withName("flPageScale"),
        SteamFlat4j.C_INT.withName("unPageSerial")
