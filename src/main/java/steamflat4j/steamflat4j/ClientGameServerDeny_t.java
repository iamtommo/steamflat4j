...
public class ClientGameServerDeny_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SteamFlat4j.C_INT.withName("m_uAppID"),
        SteamFlat4j.C_INT.withName("m_unGameServerIP"),
        SteamFlat4j.C_SHORT.withName("m_usGameServerPort"),
        SteamFlat4j.C_SHORT.withName("m_bSecure"),
        SteamFlat4j.C_INT.withName("m_uReason")
