...
public class SteamNetConnectionRealTimeStatus_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat.C_FLOAT.withName("m_flConnectionQualityLocal"),
        SteamFlat.C_FLOAT.withName("m_flConnectionQualityRemote"),
        SteamFlat.C_FLOAT.withName("m_flOutPacketsPerSec"),
        SteamFlat.C_FLOAT.withName("m_flOutBytesPerSec"),
        SteamFlat.C_FLOAT.withName("m_flInPacketsPerSec"),
        SteamFlat.C_FLOAT.withName("m_flInBytesPerSec"),
        SteamFlat.C_INT.withName("m_nSendRateBytesPerSecond"),
        SteamFlat.C_INT.withName("m_cbPendingUnreliable"),
        SteamFlat.C_INT.withName("m_cbPendingReliable"),
        SteamFlat.C_INT.withName("m_cbSentUnackedReliable"),
        SteamFlat.C_LONG_LONG.withName("m_usecQueueTime"),
        MemoryLayout.sequenceLayout(16, SteamFlat.C_INT).withName("reserved")
