...
public class GSReputation_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        SteamFlat.C_INT.withName("m_unReputationScore"),
        SteamFlat.C_BOOL.withName("m_bBanned"),
        MemoryLayout.paddingLayout(3),
        SteamFlat.C_INT.withName("m_unBannedIP"),
        SteamFlat.C_SHORT.withName("m_usBannedPort"),
        MemoryLayout.paddingLayout(6),
        SteamFlat.C_LONG_LONG.withName("m_ulBannedGameID"),
        SteamFlat.C_INT.withName("m_unBanExpires"),
