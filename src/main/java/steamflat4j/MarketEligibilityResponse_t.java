...
public class MarketEligibilityResponse_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SteamFlat.C_BOOL.withName("m_bAllowed"),
        MemoryLayout.paddingLayout(3),
        SteamFlat.C_INT.withName("m_eNotAllowedReason"),
        SteamFlat.C_INT.withName("m_rtAllowedAtTime"),
        SteamFlat.C_INT.withName("m_cdaySteamGuardRequiredDays"),
        SteamFlat.C_INT.withName("m_cdayNewDeviceCooldown")
