...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SteamFlat.C_POINTER.withName("__routine"),
        SteamFlat.C_POINTER.withName("__arg"),
        SteamFlat.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = SteamFlat.upcallHandle(__routine.Function.class, "apply", $DESC);
