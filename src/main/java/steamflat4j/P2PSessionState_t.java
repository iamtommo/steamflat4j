...
public class P2PSessionState_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SteamFlat.C_CHAR.withName("m_bConnectionActive"),
        SteamFlat.C_CHAR.withName("m_bConnecting"),
        SteamFlat.C_CHAR.withName("m_eP2PSessionError"),
        SteamFlat.C_CHAR.withName("m_bUsingRelay"),
        SteamFlat.C_INT.withName("m_nBytesQueuedForSend"),
        SteamFlat.C_INT.withName("m_nPacketsQueuedForSend"),
        SteamFlat.C_INT.withName("m_nRemoteIP"),
        SteamFlat.C_SHORT.withName("m_nRemotePort"),
