...
//void SteamAPI_ISteamClient_SetWarningMessageHook(ISteamClient ptr, SteamAPIWarningMessageHook_t pFunction);
...
//void SteamAPI_ISteamUtils_SetWarningMessageHook(ISteamUtils ptr, SteamAPIWarningMessageHook_t pFunction);
...
ISteamGameSearch SteamAPI_SteamGameSearch_v001(void);
...
ISteamMusicRemote SteamAPI_SteamMusicRemote_v001(void);
...
//void SteamAPI_ISteamInput_SetDualSenseTriggerEffect(ISteamInput ptr, InputHandle_t inputHandle, const ScePadTriggerEffectParam * pParam);
...
ISteamUGC SteamAPI_SteamUGC_v018(void);
ISteamUGC SteamAPI_SteamGameServerUGC_v018(void);
...
ISteamRemotePlay SteamAPI_SteamRemotePlay_v002(void);
...
//bool SteamAPI_ISteamNetworkingSockets_ReceivedRelayAuthTicket(ISteamNetworkingSockets ptr, const void * pvTicket, int cbTicket, SteamDatagramRelayAuthTicket * pOutParsedTicket);
//int SteamAPI_ISteamNetworkingSockets_FindRelayAuthTicketForServer(ISteamNetworkingSockets ptr, const SteamNetworkingIdentity * identityGameServer, int nRemoteVirtualPort, SteamDatagramRelayAuthTicket * pOutParsedTicket);
...
//HSteamNetConnection SteamAPI_ISteamNetworkingSockets_ConnectP2PCustomSignaling(ISteamNetworkingSockets ptr, ISteamNetworkingConnectionSignaling * pSignaling, const SteamNetworkingIdentity * pPeerIdentity, int nRemoteVirtualPort, int nOptions, const SteamNetworkingConfigValue_t * pOptions);
//bool SteamAPI_ISteamNetworkingSockets_ReceivedP2PCustomSignal(ISteamNetworkingSockets ptr, const void * pMsg, int cbMsg, ISteamNetworkingSignalingRecvContext * pContext);
